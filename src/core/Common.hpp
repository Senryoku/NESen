...
struct color_t {
    ...
    color_t(word_t _r = 255, word_t _g = 255, word_t _b = 255, word_t _a = 255) : r(_r), g(_g), b(_b), a(_a) {}

    color_t& operator=(const color_t& v) = default;
    bool     operator==(const color_t& v) { return r == v.r && g == v.g && b == v.b && a == v.a; }
    ...
    bool operator==(word_t val) { return r == g && g == b && b == a && a == val; }
