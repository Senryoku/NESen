  ...
  public:
    ...
    /*
        color_t rgb_palette[0x40] = {
            color_t(0x46, 0x46, 0x46), color_t(0x00, 0x01, 0x54), color_t(0x00, 0x00, 0x70), color_t(0x07, 0x00, 0x6b), color_t(0x28, 0x00, 0x48), color_t(0x3c, 0x00, 0x0e),
       color_t(0x3e, 0x00, 0x00), color_t(0x2c, 0x00, 0x00), color_t(0x0d, 0x03, 0x00), color_t(0x00, 0x15, 0x00), color_t(0x00, 0x1f, 0x00), color_t(0x00, 0x1f, 0x00),
       color_t(0x00, 0x14, 0x20), color_t(0x00, 0x00, 0x00), color_t(0x00, 0x00, 0x00), color_t(0x00, 0x00, 0x00), color_t(0x9d, 0x9d, 0x9d), color_t(0x00, 0x41, 0xb0),
       color_t(0x18, 0x25, 0xd5), color_t(0x4a, 0x0d, 0xcf), color_t(0x75, 0x00, 0x9f), color_t(0x90, 0x01, 0x53), color_t(0x92, 0x0f, 0x00), color_t(0x7b, 0x28, 0x00),
       color_t(0x51, 0x44, 0x00), color_t(0x20, 0x5c, 0x00), color_t(0x00, 0x69, 0x00), color_t(0x00, 0x69, 0x16),	color_t(0x00, 0x5a, 0x6a), color_t(0x00, 0x00, 0x00),
       color_t(0x00, 0x00, 0x00), color_t(0x00, 0x00, 0x00), color_t(0xfe, 0xff, 0xff), color_t(0x48, 0x96, 0xff), color_t(0x62, 0x6d, 0xff), color_t(0x8e, 0x5b, 0xff),
       color_t(0xd4, 0x5e, 0xff), color_t(0xf1, 0x60, 0xb4), color_t(0xf3, 0x6f, 0x5e), color_t(0xdc, 0x88, 0x17), color_t(0xb2, 0xa4, 0x00), color_t(0x7f, 0xbd, 0x00),
       color_t(0x53, 0xca, 0x28), color_t(0x38, 0xca, 0x76), color_t(0x36, 0xbb, 0xcb), color_t(0x2b, 0x2b, 0x2b), color_t(0x00, 0x00, 0x00), color_t(0x00, 0x00, 0x00),
            color_t(0xfe, 0xff, 0xff), color_t(0xb0, 0xd2, 0xff), color_t(0xb6, 0xbb, 0xff), color_t(0xcb, 0xb4, 0xff), color_t(0xed, 0xbc, 0xff), color_t(0xf9, 0xbd, 0xe0),
       color_t(0xfa, 0xc3, 0xbd), color_t(0xf0, 0xce, 0x9f),	color_t(0xdf, 0xd9, 0x90), color_t(0xca, 0xe3, 0x93), color_t(0xb8, 0xe9, 0xa6), color_t(0xad, 0xe9, 0xc6),
       color_t(0xac, 0xe3, 0xe9), color_t(0xa7, 0xa7, 0xa7), color_t(0x00, 0x00, 0x00), color_t(0x00, 0x00, 0x00)
        };
    */
    color_t rgb_palette[0x40] = {color_t(84, 84, 84),    color_t(0, 30, 116),    color_t(8, 16, 144),    color_t(48, 0, 136),    color_t(68, 0, 100),    color_t(92, 0, 48),
                                 color_t(84, 4, 0),      color_t(60, 24, 0),     color_t(32, 42, 0),     color_t(8, 58, 0),      color_t(0, 64, 0),      color_t(0, 60, 0),
                                 color_t(0, 50, 60),     color_t(0, 0, 0),       color_t(0, 0, 0),       color_t(0, 0, 0),       color_t(152, 150, 152), color_t(8, 76, 196),
                                 color_t(48, 50, 236),   color_t(92, 30, 228),   color_t(136, 20, 176),  color_t(160, 20, 100),  color_t(152, 34, 32),   color_t(120, 60, 0),
                                 color_t(84, 90, 0),     color_t(40, 114, 0),    color_t(8, 124, 0),     color_t(0, 118, 40),    color_t(0, 102, 120),   color_t(0, 0, 0),
                                 color_t(0, 0, 0),       color_t(0, 0, 0),       color_t(236, 238, 236), color_t(76, 154, 236),  color_t(120, 124, 236), color_t(176, 98, 236),
                                 color_t(228, 84, 236),  color_t(236, 88, 180),  color_t(236, 106, 100), color_t(212, 136, 32),  color_t(160, 170, 0),   color_t(116, 196, 0),
                                 color_t(76, 208, 32),   color_t(56, 204, 108),  color_t(56, 180, 204),  color_t(60, 60, 60),    color_t(0, 0, 0),       color_t(0, 0, 0),
                                 color_t(236, 238, 236), color_t(168, 204, 236), color_t(188, 188, 236), color_t(212, 178, 236), color_t(236, 174, 236), color_t(236, 174, 212),
                                 color_t(236, 180, 176), color_t(228, 196, 144), color_t(204, 210, 120), color_t(180, 222, 120), color_t(168, 226, 144), color_t(152, 226, 180),
                                 color_t(160, 214, 228), color_t(160, 162, 160), color_t(0, 0, 0),       color_t(0, 0, 0)};
